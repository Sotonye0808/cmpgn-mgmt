...
import TeamManagementPanel from "@/modules/teams/components/TeamManagementPanel";
import GroupManagementPanel from "@/modules/teams/components/GroupManagementPanel";
import MyTeamCard from "@/modules/teams/components/MyTeamCard";
...
function TeamPageContent() {
  ...
  useEffect(() => {
    ...
    const url =
      filter === "team" ? "/api/leaderboard/team" : "/api/leaderboard/group";
    window
      .fetch(url)
      .then((r) => r.json())
      .then((json) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {visibleSections.some((s) => s.key === "invite-links") &&
        userHasTeam &&
        canManageTeam && (
          <>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                {inviteUrl && (
                  <>
                    ...
                    />
                    <Button icon={<ICONS.copy />} onClick={handleCopyInvite}>
                      Copy
                    </Button>
                  </>
                )}

          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <strong>
                  {CATEGORY_LABEL_MAP.get(selected.category) ??
                    selected.category}
                </strong>
              </div>
              <div>
              ...
              {selected.userId && (
                <div className="col-span-2">
                  ...
                  <code className="text-xs bg-ds-surface-sunken px-1 rounded">
                    {selected.userId}
                  </code>
                </div>
              )}
              ...
              {selected.userAgent && (
                <div className="col-span-2">
                  ...
                  <span className="text-xs break-all text-ds-text-disabled">
                    {selected.userAgent}
                  </span>
                </div>
              )}
            ...
            <div>
              <h4 className="text-sm font-semibold text-ds-text-primary mb-1">
                Description
              </h4>
            ...
            <div>
              <h4 className="text-sm font-semibold text-ds-text-primary mb-2">
                Update Status
              </h4>
              <div className="flex flex-wrap gap-2">
                {BUG_REPORT_STATUSES.map((s) => (
                  <Popconfirm
                    ...
                    onConfirm={() => handleStatusUpdate(selected.id, s.key)}
                    okText="Confirm"
                    cancelText="Cancel"
